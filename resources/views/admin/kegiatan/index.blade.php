                    ...
                    <td class="px-5 py-4 text-right">
                        <div class="flex items-center justify-end gap-2">
                            ...
                            <form action="{{ route('admin.kegiatan.destroy', $kegiatan) }}" method="POST"
                                data-confirm="Kegiatan ini akan dihapus permanen dan tidak dapat dikembalikan." data-confirm-title="Hapus Kegiatan?" data-confirm-ok="Ya, Hapus" data-confirm-variant="danger">
                                @csrf @method('DELETE')
