            ...
            <div>
                ...
                <div class="mt-6 space-y-2">
                    <div class="flex items-center gap-2 text-sm text-neutral-500">
                        ...
                        <a href="tel:+622112345678" class="hover:text-primary-600 transition-colors">(021) 1234-5678</a>
                    </div>
                    <div class="flex items-center gap-2 text-sm text-neutral-500">
                        ...
                        <a href="mailto:masjid@grandcenterpoint.id" class="hover:text-primary-600 transition-colors">masjid@grandcenterpoint.id</a>
                    </div>
                </div>
            </div>
        </div>
